...
| [architecture-research-blueprint](skills/architecture-research-blueprint/) | End-to-end software and Google Cloud architecture research — orchestrates parallel specialist subagents, independent adversarial reviews across the 6 Well-Architected pillars, multi-tier executive consolidation, and interactive web reports with zero-defect Mermaid.js and Zoom/Pan lightboxes |
